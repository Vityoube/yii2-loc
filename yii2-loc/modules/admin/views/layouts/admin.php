					...
					<div class="col-sm-4">
						<div class="logo pull-left">
                                                    <a href="<?= yii\helpers\Url::home() ?>">
                                                       <?= \yii\helpers\Html::img('@web/images/home/logo.png', ['alt'=>'E-SHOPPER'])?>
                                                    </a>
						</div>
						...
						<div class="mainmenu pull-left">
							<ul class="nav navbar-nav collapse navbar-collapse">
								<li><a href="<?= yii\helpers\Url::to(['/admin']) ?>" class="active">Home</a></li>
                                                                <li class="dropdown"><a href="<?= yii\helpers\Url::to(['category/index'])?>">Categories<i class="fa fa-angle-down"></i></a>
                                    <ul role="menu" class="sub-menu">
                                        <li><a href="<?= yii\helpers\Url::to(['category/index']) ?>">List Categories</a></li>
										<li><a href="<?= yii\helpers\Url::to(['category/create'])?>">Add Category</a></li> 
                                    </ul>
                                </li> 
								<li class="dropdown"><a href="<?= yii\helpers\Url::to(['product/index']) ?>">Products<i class="fa fa-angle-down"></i></a>
                                    <ul role="menu" class="sub-menu">
                                        <li><a href="<?= yii\helpers\Url::to(['product/index']) ?>">Products List</a></li>
					<li><a href="<?= yii\helpers\Url::to(['product/create']) ?>">Add Product</a></li>
                                    </ul>
                                </li> 
								</ul>
						</div>
